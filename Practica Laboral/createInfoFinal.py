...
dataframes = {
    'data1': {
        'path': r"C:\Users\Administrador\Desktop\Practica Laboral\IMIAS\ok.csv",
        'data': pd.read_csv(r"C:\Users\Administrador\Desktop\Practica Laboral\IMIAS\ok.csv")
    },
    'data2': {
        'path': r"C:\Users\Administrador\Desktop\Practica Laboral\MAYAS\ok.csv",
        'data': pd.read_csv(r"C:\Users\Administrador\Desktop\Practica Laboral\MAYAS\ok.csv")
    },
    'data3': {
        'path': r"C:\Users\Administrador\Desktop\Practica Laboral\STE2S\ok.csv",
        'data': pd.read_csv(r"C:\Users\Administrador\Desktop\Practica Laboral\STE2S\ok.csv")
    },
    'data4': {
        'path': r"C:\Users\Administrador\Desktop\Practica Laboral\STERS\ok.csv",
        'data': pd.read_csv(r"C:\Users\Administrador\Desktop\Practica Laboral\STERS\ok.csv")
    }
}
...
for key, values in dataframes.items():
    ...
    infoPath = os.path.join(directory,'InfoFin.txt')
